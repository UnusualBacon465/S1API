...
namespace S1API.UI
{
    public static class UIFactory
    {
        ...
        /// </summary>
        public static Text Text(string name, string content, Transform parent, int fontSize = 16,
        ...
        /// </summary>
        public static RectTransform ScrollableVerticalList(string name, Transform parent,
